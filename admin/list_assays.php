...
{
	$edit_query="DELETE FROM `assays` WHERE `id`='$_REQUEST[delid]'";
	if(@mysql_query($edit_query))
	{
		header("location:list_assays.php?msg=ais");
	}
	else
	{
		header("location:list_assays.php?msg=aif");
	}
}
...
$del_id = $checkbox[$i];
$sql = "DELETE FROM `assays` WHERE id='$del_id'";
mysql_query($sql); 
}
header("location:list_assays.php?msg=ais");
}
	...
	<?php include('includes/admin_header.php');?>
		<div class="admin_area">
			...
			<div class="admin_module_area">
				<div class="admin_title"><div class="admin_title_img"><img src="images/icon_content.gif" style="height:30px; vertical-align:middle;" /></div><div class="admin_title_text">Assays List</div></div><!--admin_title ends-->
				...
				<table width="800">
					...
					<tr>
						...
						<th width="5%">ID</th>
						<th width="80%">Assay Name</th>
						<th width="10%">Action</th>
					</tr>
					<?php
					
					$list_query = mysql_query("SELECT * FROM `assays` ORDER BY `id` DESC");
					...
					<tr>
						...
						<td>&nbsp;&nbsp;<img src="images/b_edit.png" title="edit" style="cursor:pointer;" onclick="window.location='add_assays.php?id=<?php echo $list['id'];?>'" />&nbsp;&nbsp;&nbsp;&nbsp;
						<a href="list_assays.php?delid=<?php echo $list['id'];?>"><img src="images/b_drop.png" title="Delete" style="cursor:pointer;" onclick="return confirm('are you sure want to delete this assay!');" /></a></td>
					</tr>
					<?php } ?>
				</table>
				</form>
